...
const ProductCategoryDetailPage = () => {
  ...
  const staticData = productCategories.find((item) => item.i18nKey === i18nKey);
      ...
      <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-16 py-20 h-screen flex flex-col items-center justify-center">
          ...
          <p className="mt-4 text-lg">
            {t("product.notFound.categoryDescription", { categorySlug })}
          </p>
  ...
  categoryData.products = categoryData.products.map((product: ProductItem) => ({
    ...product,
    img: imagesForThisCategory[product.key] || "/images/placeholder.jpg",
  }));
