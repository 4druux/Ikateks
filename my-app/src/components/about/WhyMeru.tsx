import { whyMeru } from "../../data/about";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8">
        {whyMeru.map((item) => {
          ...
          const translation = t(`aboutPage.whyMeru.items.${item.i18nKey}`, {
            returnObjects: true,
