  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full p-6 text-white">
        ...
        <p className="mt-2 md:max-h-0 text-zinc-200 opacity-100 md:opacity-0 transition-all duration-500 group-hover:max-h-40 group-hover:opacity-100 line-clamp-2 md:line-clamp-4">
          {item.description}
        </p>
      </div>
    </div>
