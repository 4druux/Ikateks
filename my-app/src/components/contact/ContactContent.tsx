            ...
            <div className="bg-white md:p-6 rounded-xl md:shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  >
                    <p>
                      {t("contactPage.section.form.labels.name")}{" "}
                ...
                <div>
                  ...
                  >
                    <p>
                      {t("contactPage.section.form.labels.email")}{" "}
                      <span className="text-red-600">*</span>
                    </p>
                  </label>
                  <input
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-medium text-zinc-700 mb-2"
                  >
                    {t("contactPage.section.form.labels.company")}
                  </label>
                  <input
                    type="text"
                    id="company"
                ...
                <div>
                  ...
                  >
                    <p>
                      {t("contactPage.section.form.labels.message")}{" "}
                      <span className="text-red-600">*</span>
                    </p>
                  </label>
                  <textarea
