...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: t("nav.customers"), path: "/customer" },
  ];
                  ...
                  >
                    ...
                    <span
                      className={`absolute bottom-0.5 left-1/2 -translate-x-1/2 w-1/2 h-[2px] transition duration-500 transform ${
                        isTop && !isOpen ? "bg-white" : "bg-red-700"
                      } ${
                        isActive(link.path)
                          ? "scale-x-100"
                ...
                <div className="flex items-center text-sm font-medium">
                  <Globe
                    className={`w-5 h-5 mb-0.5 transition-colors duration-200 ${
                      isTop && !isOpen ? "text-white" : "text-red-700"
                    }`}
                  />
                  ...
                  <span
                    className={
                      isTop && !isOpen ? "text-zinc-400" : "text-zinc-300"
                    }
                  >
                    |
                  </span>
                ...
                <div className="flex items-center">
                  ...
                  >
                    {isOpen ? (
                      ...
                      <Menu
                        className={`h-6 w-6 ${
                          isTop ? "text-white" : "text-zinc-700"
                        }`}
                      />
                    )}
                  </button>
